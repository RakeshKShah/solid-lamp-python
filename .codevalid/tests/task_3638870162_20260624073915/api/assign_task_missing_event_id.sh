...
CASE_SUFFIX="$(date +%s)-$$"
TASK_RESP="/tmp/assign_task_missing_event_id_task_${CASE_SUFFIX}.json"
RESP_FILE="/tmp/assign_task_missing_event_id_resp_${CASE_SUFFIX}.json"
STATUS_FILE="/tmp/assign_task_missing_event_id_status_${CASE_SUFFIX}.txt"
TASK_ID=""
cleanup_files() {
...
CURRENT_EVENT_ID="$(jq -r '.event_id' "$TASK_RESP")"
[ "$CURRENT_EVENT_ID" = "null" ]

echo "CODEVALID_TEST_ASSERTION_OK:assign_task_missing_event_id"
