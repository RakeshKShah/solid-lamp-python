...
CASE_SUFFIX="$(date +%s)-$$"
TASK_TITLE="Standalone task ${CASE_SUFFIX}"
RESPONSE_FILE="/tmp/create_task_null_event_id_${CASE_SUFFIX}.json"
STATUS_FILE="/tmp/create_task_null_event_id_${CASE_SUFFIX}.status"
TASK_ID=""
...
echo "CODEVALID_TEST_ASSERTION_OK:create_task_null_event_id"
